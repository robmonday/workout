...
export function Modal({
  ...
  return (
    <div className="absolute top-0 z-20 flex h-[100%] overflow-y-auto w-full place-content-center items-start justify-center overflow-clip bg-black bg-opacity-60">
